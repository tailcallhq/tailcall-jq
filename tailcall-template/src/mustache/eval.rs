use super::mustache::{Mustache, Segment};
use crate::mustache::path::{PathGraphql, PathString};
...
impl<A> Default for PathGraphqlEval<A> {
    fn default() -> Self {
        Self::new()
    }
}
...
mod tests {
    ...
    mod render {
        ...
        use crate::mustache::path::PathString;
    ...
    mod render_graphql {
        use crate::mustache::mustache::{Mustache, Segment};
        use crate::mustache::path::PathGraphql;
